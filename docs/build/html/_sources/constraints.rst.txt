...
----------------
    ...
    application. **The application should not larger than 1GB.** For another aspect, when 
    the application starts data analyzing, memory occupancy must be limited under a 
    certain level to make sure the system work in a proper way. 
